CREATE TABLE VENTAS 
   ...
   DescripcionProducto varchar(70) NULL,
...
INSERT INTO CLIENTE(IdCliente,NombresCliente,ApellidosCliete,CedulaIdentificacion,Direccion,Telefono,Emailcliente)VALUES
